...
tags_metadata = [
    ...
    },
    {
        ...
        'name': 'AI',
        'description': 'Endpoints that generate content using AI.',
    }, {
        'name': 'Internal · Tracking',
        'description': 'Internal endpoints not to be seen by end users.',
    }
]
...
class SubjSourceBase(BaseModel):
    specialty: str
    title: str
    description: str

class SubjSource(BaseModel):
    articles: List[SubjSourceBase]


class GeneratedSubjectLine(BaseModel):
    specialty: str
    title: str
    description: str
    subject_line: str
...
GeneratedSubjectLineList = List[GeneratedSubjectLine]

class GeneratedSubjectLineResp(RootModel[List[GeneratedSubjectLine]]):
    root: List[GeneratedSubjectLine]


class DetectionPosts(BaseModel):
    post_id: str
    post_content: str
...
AIDetectionList = List[AIDetection]

class AIDetectionResp(RootModel[AIDetectionList]):
    root: AIDetectionList
